...
var backdropClassNames = new Set([componentBaseClassNames.View, componentBaseClassNames.Header, componentBaseClassNames.Footer, componentBaseClassNames.Track].map(className));
    ...
    value: function render() {
      ...
      return glam(
        ...
        glam(
          ...
          preventScroll && glam(ScrollLock, null)
        )
      );
    }
  }]);
...
var ModalGateway = function (_Component) {
  ...
  createClass(ModalGateway, [{
    ...
    value: function render() {
      ...
      return reactDom.createPortal(React__default.createElement(reactTransitionGroup.TransitionGroup, { component: FirstChild, children: children }), target);
    }
  }]);
  return ModalGateway;
}(React.Component);
...
Carousel$1.ModalGateway = ModalGateway;
Carousel$1.Modal = Modal;
Carousel$1.carouselComponents = carouselComponents;
Carousel$1.modalComponents = modalComponents;
